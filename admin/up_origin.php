    ...
    <div id="layout" class="pure-g">
        ...
        <div class="content pure-u-1 pure-u-md-21-24">
            <div class="header-small">
                <div class="items">
                    <?php include "includes/insert_origin.php" ?>
                    <h1 class="subhead">Add Origin</h1>
                    <form action="" method="post" autocomplete="off" enctype="multipart/form-data" class="pure-form pure-form-stacked">
                        <fieldset>
                            ...
                            <button  name="insert_origin" value="Add Brand" class="pure-button button-success">Save</button>
                        </fieldset>
                    </form>
                </div>    
            </div>
